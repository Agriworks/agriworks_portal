      ...
      <div class="col-md-6" id="loginFormContainer">
        <v-card class="rounded-card" :elevation="5">
          <div class="card-body">
            ...
            />
            <v-form>
              <v-text-field v-model="email" label="Username" type="email" autofocus required />
              <v-text-field
                v-model="password"
                label="Password"
      ...
      <div class="col-md-6" id="infoContainer">
        ...
        <ul id="bulletPoints">
          <li class="bulletPoint">
            <v-icon medium color="#96D34A">mdi-hammer-screwdriver</v-icon>Create and share datasets
          </li>
          <li class="bulletPoint">
            <v-icon medium color="#96D34A">mdi-graph</v-icon>Visualize your datasets
          </li>
          <li class="bulletPoint">
            <v-icon medium color="#96D34A">mdi-send</v-icon>Formulate dataset templates for data collection
          </li>
        </ul>
        <div id="h4iStampContainer">
          <h5>
            Proudly built by
            <a href="https://www.hack4impactbu.com/index.html" target="_blank">
              <img src="../assets/hack4impactlogo.png" width="35%" />
            </a>
          </h5>
        </div>
      </div>
